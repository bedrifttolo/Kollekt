...
// Original alcohol-themed wording for the Kollekt party game, preserved verbatim from
// before the App Store neutral-content rewrite. Looked up by template id (see
// alcoholLookup.ts) and only ever reachable when GameConfig.alcoholMode is true, which
// itself only happens in a build where VITE_ENABLE_ALCOHOL_MODE was set at build time —
// see src/lib/kollektGame.ts. Never wired into the default (App Store) content path.
...
export const ALCOHOL_STAT_COMP_TEMPLATES: StatCompTemplate[] = [
...
export const ALCOHOL_CHALLENGE_TEMPLATES: ChallengeTemplate[] = [
  // Improved existing prompts
  {
    id: 'streak-name',
...
export const ALCOHOL_GUEST_CHALLENGE_TEMPLATES: ChallengeTemplate[] = [
  // Improved existing prompts
  {
...
export const ALCOHOL_HOT_SEAT_TEMPLATES: HotSeatTemplate[] = [
  // Improved existing prompts
  {
    id: 'who-slacks',
...
export const ALCOHOL_GUEST_HOT_SEAT_TEMPLATES: HotSeatTemplate[] = [
  // Improved existing prompts
  {
    id: 'guest-best-host',
...
export const ALCOHOL_TRIVIA_TWIST_TEMPLATES: TriviaTwistTemplate[] = [
  // Improved existing prompts
  {
    id: 'streak-compare',
...
export const ALCOHOL_RANDOM_EVENT_TEMPLATES: RandomEventTemplate[] = [
  // Improved existing prompts
  {
    id: 'waterfall',
