...
export default function CharadesGame({ players, onClose }: { players: string[]; onClose: () => void }) {
  ...
  return (
    <GameScreen>
      <GameHeader eyebrow={t('social.games.catalog.charades')} title={t('social.games.charadesGame.turn', { player })} onClose={onClose} />
