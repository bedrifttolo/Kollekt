...
export const GAME_CATALOG: GameEntry[] = [
  ...
  { id: 'liars-dice', titleKey: 'liarsDice', descriptionKey: 'liarsDice', emoji: '🥤', category: 'classic', difficulty: 'medium', minPlayers: 1, minutes: 15, playable: true, soloGame: true },
  ...
  { id: 'truth-or-chug', titleKey: 'truthOrChug', descriptionKey: 'truthOrChug', emoji: '🍻', category: 'party', difficulty: 'party', minPlayers: 2, minutes: 25, playable: true, drinkingGameId: 'truth-or-chug' },
  { id: 'never-have-i-ever', titleKey: 'neverHaveIEver', descriptionKey: 'neverHaveIEver', emoji: '🙈', category: 'party', difficulty: 'party', minPlayers: 2, minutes: 20, playable: true, drinkingGameId: 'never-have-i-ever' },
