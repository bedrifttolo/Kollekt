...
export const GAME_CATALOG: GameEntry[] = [
  ...
  { id: 'snusboksen', titleKey: 'snusboksen', descriptionKey: 'snusboksen', emoji: '🥫', category: 'party', difficulty: 'party', minPlayers: 2, minutes: 15, playable: true, requiresSubscription: true },
];
