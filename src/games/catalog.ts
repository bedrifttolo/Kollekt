...
export const GAME_CATALOG: GameEntry[] = [
  ...
  { id: 'kollekt', titleKey: 'kollekt', descriptionKey: 'kollekt', icon: House, category: 'classic', difficulty: 'medium', minPlayers: 2, minutes: 20, playable: true, requiresSubscription: true },
