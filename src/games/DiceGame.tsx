    ...
    <div className="fixed inset-0 z-[60] flex flex-col bg-background safe-top safe-bottom">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-10 px-6 pb-20 text-center" style={{ perspective: 900 }}>
        <motion.button
          ...
          className="grid h-44 w-44 place-items-center rounded-[2.25rem] border-4 border-primary/20 bg-card text-[9rem] leading-none text-primary shadow-[0_24px_60px_rgba(16,32,25,.22)] disabled:cursor-wait"
